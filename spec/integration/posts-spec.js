...
//------------------------ MEMBER USER ----------------------------
  ...
  describe('member user performing CRUD actions for Post', () => {
    ...
    describe('POST /topics/:topicId/posts/:id/destroy', () => {
      it('should not delete the post that the member does not own', (done) => {
        Post.all()
        .then((posts) => {
          const postCountBeforeDelete = posts.length;
          expect(postCountBeforeDelete).toBe(1);
      ...
      it('should delete a post that the member owns', (done) => {
        const options = {
          url: `${base}/${this.topic.id}/posts/create`,
          form: {
            title: 'Watching snow melt',
    ...
    describe('GET /topics/:topicId/posts/:id/edit', () => {
      it('should not render a view with an edit post form for post member does not own', (done) => {
        request.get(`${base}/${this.topic.id}/posts/${this.post.id}/edit`, (err, res, body) => {
          expect(body).not.toContain('Edit Post');
          expect(body).toContain('Snowball Fighting');
          done();
      ...
      it('should render a view with an edit post form for post member owns', (done) => {
        const options = {
          url: `${base}/${this.topic.id}/posts/create`,
          form: {
            title: 'Watching snow melt',
        ...
        request.post(options, (err, res, body) => {
          ...
          .then((post) => {
            ...
            request.get(`${base}/${this.topic.id}/posts/${post.id}/edit`, (err, res, body) => {
              ...
              expect(body).toContain('Watching snow melt');
              done();
            });
          });
        });
    ...
    describe('POST /topics/:topicId/posts/:id/update', () => {
      it('should update a member-owned post with the given values', (done) => {
        const options = {
          url: `${base}/${this.topic.id}/posts/create`,
          form: {
            title: 'Watching snow melt',
        ...
        request.post(options, (err, res, body) => {
          ...
          .then((post) => {
            const newOptions = {
              ...
              form: {
                title: 'Snowman Building Competition',
                body: 'I like to see how fast they can build!'
              }
            };
      ...
      it('should not update member-not-owned post with given values', (done) => {
        request.post({
          url:`${base}/${this.topic.id}/posts/${this.post.id}/update`,
          form: {
            title: 'Snowman Building Competition',
